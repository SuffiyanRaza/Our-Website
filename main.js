(function ($) {
  ...
  */
  ...
  --------------------------------------------------------------*/
  function rippleInit() {
    if ($('.cs-ripple_version').exists()) { // Now using the helper function
  ...
  $(document).ready(function(){
    let slideIndex = 0;
    const totalSlides = $('.cs-testimonial_slider_right .slider-for_item').length;
    ...
    setInterval(function() {
      ...
      $('.cs-testimonial_slider_right .slider-for').slick('slickGoTo', slideIndex);
  ...
  function ecommerce() {
    ...
    // Counter
    $('.cs-increment, .cs-decrement').click(function () {
      var countElement = $(this).siblings('.cs-quantity_input');
      var count = parseInt(countElement.text());
      
      if ($(this).hasClass('cs-increment')) {
        count++;
      } else if ($(this).hasClass('cs-decrement') && count > 0) {
        count--;
      }
  ...
  if ($.exists('#cs-form')) {
    ...
    form.addEventListener('submit', function (e) {
        ...
        // Set "Please wait..." message in red
